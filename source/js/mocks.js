...
const MAX_COUNT_OF_ROOMS = 100;
const MAX_COUNT_OF_GUESTS = 1000;
...
const getAd = () => {
  ...
  return {
    ...
    offer: {
      ...
      rooms: getRandomInt(0, MAX_COUNT_OF_ROOMS),
      guests: getRandomInt(0, MAX_COUNT_OF_GUESTS),
